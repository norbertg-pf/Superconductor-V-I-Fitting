...
def setup_data_fitting_tab_layout(app):
    ...
    graph_toolbar = QGridLayout()
    graph_toolbar.setHorizontalSpacing(6)
    graph_toolbar.setVerticalSpacing(4)
    graph_toolbar.addWidget(app.data_fit_graph_btn, 0, 0)
    graph_toolbar.addWidget(app.data_fit_robust_view_btn, 0, 1)
    graph_toolbar.addWidget(app.data_fit_zoom_mode_btn, 1, 0)
    graph_toolbar.addWidget(app.data_fit_reset_view_btn, 1, 1)
    ch_grid.addLayout(graph_toolbar, 6, 0, 1, 4)
